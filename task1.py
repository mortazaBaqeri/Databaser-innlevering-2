...
from Backup.UserManager import UserManager
from Backup.ActivityManager import ActivityManager
from Backup.DataFetcher import DataFetcher
...
def main():
    ...
    try:
        ...
        # Create tables
        user_manager.insert_users(data_dir="./Dataset/dataset/Data")
        activity_manager.insert_activities(data_dir="./Dataset/dataset/Data")
        
        # Fetch and display data
        for table in ["User", "Activity", "TrackPoint"]:
            data_fetcher.fetch_data(table)
        
        data_fetcher.show_tables()
